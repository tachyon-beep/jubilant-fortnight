...
class GameService:
    ...
    def _compute_recruitment_chance(
        ...
        *,
        ...
        """Delegate to services.recruitment; retained for backward compatibility."""

        return _compute_recruitment_chance_svc(
            player=player, faction=faction, base_chance=base_chance
        )
    ...
    def _relationship_bonus(
        ...
        return _relationship_bonus_svc(
            scholar=scholar, player_id=player_id, active_for_player=active_for_player
        )
