...
Further reading: [High-Level Design](docs/HLD.md) · [System Architecture](docs/SYSTEM_ARCHITECTURE.md).
...
See `.env.example` for the full template, including optional Qdrant hooks.
...
| `pytest -q` | Full unit/integration suite (283+ tests). |
...
- [Archive Log](docs/ARCHIVE_LOG.md)
