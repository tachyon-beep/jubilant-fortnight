...
- **Gap:** Deep-prep sideways catalogue coverage still skews toward a handful of vignettes; continue expanding YAML entries so each expedition/prep depth combination has multiple narrative branches, and capture safety review notes for the new randomized tone packs.【F:great_work/expeditions.py†L280-L360】【F:great_work/data/sideways_vignettes.yaml†L1-L36】【F:great_work/data/press_tone_packs.yaml†L1-L220】
